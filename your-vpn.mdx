...
**![Search for OpenVPN Access Server](resources/your-vpn/001.png)**

### Step 2: Create the Resource

Click on the "Create" button as shown below.

**![Click Create](resources/your-vpn/002.png)**
...
**![Connect via SSH](resources/your-vpn/003.png)**

You'll see the initial configuration screen as shown below.

**![Initial Configuration](resources/your-vpn/004.png)**

Enter "yes" to indicate your agreement.

**![Agree](resources/your-vpn/005.png)**
...
**![Admin UI Step 1](resources/your-vpn/006.png)**
**![Admin UI Step 2](resources/your-vpn/007.png)**

### Step 6: Access the Client URL

Next, go to the Client URL. It should look something like this:

**![Client URL](resources/your-vpn/008.png)**
